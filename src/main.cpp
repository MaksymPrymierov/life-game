...
void help()
{
        ...
        fmt::print("\nReport bugs to <https://github.com/MaksymPrymierov/life-game/issues>\n");
}
        ...
        for (const auto& i : args) {
                if (i == "--help" || i == "-h") {
                        ...
                        if (!is_game_screen) {
                                ...
                                fmt::print(fg(fmt::color::red), "Error: You can choose only one game screen\n");
                                return -1;
                        }
                        ...
                        fmt::print(fg(fmt::color::red), "Error: Unknow argument {}. Try to use --help argument.\n", i);
                }
        }
